...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.5.11/PHP';
     ...
     * @var string
     */
    protected $sdkVersion = 'OpenAPI-Generator/2.5.11/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 2024-04-28' . PHP_EOL;
        $report .= '    SDK Package Version: 2.5.11' . PHP_EOL;
